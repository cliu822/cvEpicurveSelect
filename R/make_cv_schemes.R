...
#' @param n_cv_schemes Number of replicate CV block labelings schemes to generate
...
#'
#' @return A list of length n_cv_schemes. Each element is a character vector of length tot_ts,
